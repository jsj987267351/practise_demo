...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/mybatis_plus/src/main/java/mybatis_plus/demo4");    //设置代码生成位置
        globalConfig.setOpen(false);    //设置生成完毕后是否打开生成代码所在的目录
        globalConfig.setAuthor("张朝证");    //设置作者
...
//        //设置包名相关配置
        ...
        packageInfo.setParent("aaa");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
...
//        //策略设置
        ...
        strategyConfig.setInclude("tb_user","tb_brand");  //设置当前参与生成的表名，参数为可变参数  数据库中
